def calculate_risk_reward(entry_price, higher_high, tp_percent=20, expected_drop_percent = 30):
    """
    ...
    Parameters:
        ...
        expected_drop_percent (float): Expected percentage drop (from higher high).
    ...
    if expected_drop_percent > 0:
        expected_bottom = higher_high * (1 - expected_drop_percent / 100)
    else:
